...
{Nov 2019 - Jan 2019}
{AxxonSoft LLC. $\vert$ Moscow, Russia}
{	
\begin{itemize}
	\item{Research of machine learning/deep learning based surveillance person re-identification methods.}
	\item{Applied video background subtraction to improve the quality of \href{https://arxiv.org/abs/1905.00953}{OSNet} model for image-based person re-identification on the \href{https://researchdata.ands.org.au/saivt-soft-biometric-saivt-softbio/671976}{SAIVT-SoftBio} dataset}
\end{itemize}
}
\ExperienceEntry
