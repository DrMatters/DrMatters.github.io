...
\begin{itemize}
  ...
  \item[]{\SkillsEntry{Data Science Frameworks}{Pytorch, Scikit-learn, Pandas, NumPy, Matplotlib, NLTK, SpaCy}}
...
\ExperienceEntry
{Data Scientist in NLP (part-time)}
{Sep 2020 - Now}
{Sberbank $\vert$ Moscow, Russia}
{	
\begin{itemize}
	\item{Apply NLP/Deep Learning techniques to solve tasks for other business units.}
\end{itemize}
}
\ExperienceEntry
{AI Video Processing Specialist (part-time)}
{Apr 2020 - Sep 2020}
